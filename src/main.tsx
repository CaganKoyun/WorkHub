  ...
  root.innerHTML = `
    <div style="min-height:100vh;display:flex;align-items:center;justify-content:center;background:#0F0F13;color:#F4F5F8;font:14px/1.5 Inter,system-ui,sans-serif;padding:24px">
      <div style="max-width:600px">
        <div style="display:inline-flex;align-items:center;gap:8px;padding:4px 10px;border:1px solid #C6F432;border-radius:999px;background:rgba(198,244,50,.12);color:#C6F432;font-size:11px;font-weight:600;letter-spacing:.06em;text-transform:uppercase">Başlatma engellendi</div>
        <h1 style="margin:16px 0 8px;font-size:22px;font-weight:600;letter-spacing:-.02em">Supabase ortam değişkenleri eksik</h1>
        <p style="margin:0 0 12px;color:#8A8F98">
          Spark WorkHub, derleme sırasında Supabase URL/key çözümleyemedi.
        </p>
        <div style="margin:0 0 16px;padding:10px 12px;border:1px solid #262933;border-radius:6px;background:#151820;font-family:'Geist Mono',ui-monospace,monospace;font-size:11.5px;line-height:1.7">
          URL   → ${url ? "<span style=\"color:#22c55e\">OK</span>" : "<span style=\"color:#ef4444\">eksik</span>"}<br/>
          KEY   → ${key ? "<span style=\"color:#22c55e\">OK</span>" : "<span style=\"color:#ef4444\">eksik</span>"}
        </div>
        <p style="margin:0 0 8px;color:#8A8F98;font-size:12.5px">Derlemede görülen ortam değişkenleri (Supabase/Vercel):</p>
        <ul style="margin:0 0 16px;padding:0;list-style:none;font-family:'Geist Mono',ui-monospace,monospace;font-size:11.5px">
          ${
            seenKeys.length === 0
              ? '<li style="padding:6px 10px;border:1px solid #262933;border-radius:6px;background:#151820;color:#ef4444">(yok — Vite sıfır eşleşen ortam değişkeni gösteriyor)</li>'
        ...
        <p style="margin:0;color:#8A8F98;font-size:12.5px">
          Vercel'de (Project → Settings → Environment Variables) kabul edilen
          isimlerden biriyle URL + publishable/anon key ekleyin, ardından
          son commit'i yeniden deploy edin.
        </p>
      </div>
    </div>
  `;
